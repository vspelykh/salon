...
public class ListenerConstants {
    ...
    public static final String FEEDBACK_EMAIL = "Dear %s.<br>  Please leave feedback about your visit to the %s yesterday."
            + "Hope you enjoyed your visit to our salon!<br>  We’re constantly striving to provide excellent service for " +
            "our clients. We’d love to get your feedback through a brief customer survey.<br>" +
            "<a href=%s>Leave feedback on our website.</a> <br> Thank you for your time. We really appreciate it!";
}