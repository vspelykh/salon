...
import static ua.vspelykh.salon.model.dao.postgres.DaoTestData.getTestFeedback;
import static ua.vspelykh.salon.model.dao.postgres.SqlConstants.Feedbacks.*;
...
class FeedbackDaoImplTest extends AbstractDaoTest {
    ...
    void countFeedbacksByMasterId() throws SQLException, DaoException {
        try (PreparedStatement statement = mockPrepareStatement()) {
            ...
            int count = mockFeedbackDao.countByMasterId(ID_VALUE);
