...
@Configuration
@OpenAPIDefinition(info = @io.swagger.v3.oas.annotations.info.Info(title = "user"))
@SecurityScheme(
        name = "bearerAuth",
...
public class SwaggerConfig {
    ...
    public GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                .group("user")
                .packagesToScan("ua.vspelykh.usermicroservice.controller")
                .packagesToExclude("ua.vspelykh.usermicroservice.controller.**")
                .build();
    }
        ...
        return new OpenAPI()
                ...
                .tags(Collections.singletonList(new Tag().name("General Information")
                        .description("Please note that when interacting with the API outside of Swagger, replace the " +
                                "base path \"/api/v1\" with \"user\". This adjustment ensures proper communication with " +
